                                            ...
                                            @if (isset($buildings) && count($buildings) > 0)
                                                @foreach ($buildings as $building)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="{{ route('buildings.mark-sold', $building->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PATCH')
                                                        ...
                                                        <td>
                                                            <form
                                                                action="{{ route('buildings.toggle-website', $building->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit"
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('buildings.destroy', $building->id) }}"
                                                                ...
                                                                <button type="submit" class="btn btn-sm btn-danger"
                                                                    onclick="return confirm('Yakin ingin tandai sebagai terjual?')"><i class="bi bi-trash"></i></button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                @endforeach
